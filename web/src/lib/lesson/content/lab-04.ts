...
export const LAB_04_CHUNKS: readonly LessonChunk[] = [
  ...
  },
  {
    ...
    actions: [
      {
        text: "Create a workflow with a Webhook node named Receive Lead Request.",
        code: {
          language: "text",
          code: [
            "HTTP Method: POST",
      ...
      {
        text: "Clean each field by its own rule, convert DD/MM/YYYY dates to YYYY-MM-DD, and keep the original input alongside the cleaned version. Read each rule before you run it — the notes below explain the two that matter most.",
        code: {
          language: "javascript",
          code: [
        ...
        expect: "A normalized object beside a raw_input object, and 08/09/2026 becomes 2026-09-08.",
      },
    ],
    whyWereDoingThis: [
      {
  ...
  },
  {
    ...
    actions: [
      {
        text: "Add a Code node named Validate Lead Data, also Run Once for Each Item. It collects every error into an array rather than stopping at the first, checks the phone has 10 to 15 digits, and checks the date is a calendar date that really exists.",
        code: {
          language: "javascript",
          code: [
      ...
      {
        text: "Add an IF node named Is Lead Valid? with the Boolean condition {{ $json.validation.is_valid }} is true.",
      },
      {
        text: "On false, add a Respond to Webhook node named Return Validation Errors: Respond With JSON, Response Code 400, and this Response Body.",
        code: {
          language: "javascript",
          code: [
            "{{",
      ...
      {
        text: "On true, add Return Valid Lead: Respond With JSON, Response Code 200, and this Response Body.",
        code: {
          language: "javascript",
          code: [
            "{{",
    ...
    content: [
      {
        ...
        items: [
          {
            text: "With curl, send your Production URL a lead whose email field is named email_address instead of email, but is otherwise perfectly valid.",
            code: {
              language: "json",
